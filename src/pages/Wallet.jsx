                ...
                <div style={{ background: 'var(--bg-card)', padding: '20px', borderRadius: '20px' }}>
                    ...
                    {!confirmationCode ? (
                        ...
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <button onClick={() => { setMode('home'); setPaymentPin(''); }} style={{ width: '100%', padding: '15px', borderRadius: '10px', border: 'none', background: '#9C27B0', color: 'white', fontWeight: 'bold' }}>Done</button>
                        </div>
                    )}
                </div>
            )}
